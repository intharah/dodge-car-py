...
class GameScene(SceneBase):
    def __init__(self, screen, inputpi, settings, width, height, sfx):
        ...
        self.lifeP1 = 100
        self.lifeP2 = 100
        #self.titleScene = TitleScene(self.screen, self.inputpi, self.settings, self.width, self.height, self.sfx)
        ...
        self.car = CarSprite(rect.center, my_car_num)
    ...
    def ProcessInput(self, events, pressed_keys):
        ...
        for event in events:
            ...
            if self.crash == False:
                ...
                #self.SwitchToScene(self.titleScene)
                print "restart"
